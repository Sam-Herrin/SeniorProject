...
$conn->query($query);
$query = "INSERT INTO msstate(LibraryName,City,Country,Website,ManuscriptName,Author,BirthDate,DeathDate,Notes,OorC) VALUES(4,'Österreichische Nationalbibliothek','Wien','Austria',NULL,'Abbreviatio Chronicae a Mundo Condito usque ad Carolum Magnum','Unknown','Unknown','Unknown','None','Copy');";
$conn->query($query);
$query = "INSERT INTO msstate(LibraryName,City,Country,Website,ManuscriptName,Author,BirthDate,DeathDate,Notes,OorC) VALUES(5,'Österreichische Nationalbibliothek','Wien','Austria',NULL,'Abbreviatio Chronicae ab Adamo usque ad Annum 809','Unknown','Unknown','Unknown','None','Copy');";
$conn->query($query);
$query = "INSERT INTO msstate(LibraryName,City,Country,Website,ManuscriptName,Author,BirthDate,DeathDate,Notes,OorC) VALUES(6,'Bibliothèque Nationale','Paris','France',NULL,'Abbreviatio Chronicae Bedanae','Unknown','Unknown','Unknown','None','Copy');";
$conn->query($query);
$query = "INSERT INTO msstate(LibraryName,City,Country,Website,ManuscriptName,Author,BirthDate,DeathDate,Notes,OorC) VALUES(7,'British Library','London','England',NULL,'Abbreviatio de Gestis Normannorum ad Gulielmum I Regem Angliae','Unknown','Unknown','Unknown','None','Copy');";
$conn->query($query);
$query = "INSERT INTO msstate(LibraryName,City,Country,Website,ManuscriptName,Author,BirthDate,DeathDate,Notes,OorC) VALUES(8,'Bibliothèque Nationale','Paris','France',NULL,'Abbreviatio Gestorum Regum Francorum (Historia Francorum Monasterii Sancti Dionysii)','Unknown','Unknown','Unknown','None','Copy');";
$conn->query($query);
$query = "INSERT INTO msstate(LibraryName,City,Country,Website,ManuscriptName,Author,BirthDate,DeathDate,Notes,OorC) VALUES(9,'Newberry Library','Chicago','United States of America',NULL,'Abbreviationes Chronicorum','Unknown','Unknown','Unknown','None','Copy');";
$conn->query($query);
